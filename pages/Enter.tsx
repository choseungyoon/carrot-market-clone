    ...
    <div className="mt-16">
      ...
      <div className="mt-16 mx-4">
        <div className="flex flex-col items-center">
          ...
          <div className="grid  pb-4 border-b w-full grid-cols-2 mt-8 gap-16">
            <button
              className={cls(
                "pb-4  font-medium",
                method === "phone"
        ...
        <form className="flex flex-col mt-3">
          <label htmlFor="input" className="text-sm font-medium text-center">
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="grid grid-cols-2 mt-2 pt-4 gap-3">
              <button className="flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm font-medium text-gray-500 hover:bg-gray-50">
                <svg
                  className="w-5 h-5"
                  aria-hidden="true"
                  fill="currentColor"
